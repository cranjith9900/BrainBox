const SliderOne = () => {
  return (
    <div className="relative flex flex-col lg:flex-row w-full my-6 rounded-lg px-6 md:px-12 lg:px-20 py-12">
      {/* Image Section */}
      <div className="relative mb-8 lg:mb-0 lg:w-2/5 shrink-0 overflow-hidden">
        <img
